...
public class DateChooseButton extends JButton {
	...
	public DateChooseButton(SimpleDateFormat df, String dateString) {
		this();
	...
	public DateChooseButton(Date date) {
		this("", date);
		// 记忆原始日期时间
		initOriginalText(date);
	}

	public DateChooseButton(String preLabel, Date date) {
		if (preLabel != null) {
	...
	private class DateChooser extends JPanel implements ActionListener,
		...
		void showDateChooser(Point position) {
			Frame owner = (Frame) SwingUtilities
					.getWindowAncestor(DateChooseButton.this);
