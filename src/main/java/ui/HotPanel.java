...
public class HotPanel extends JPanel {
	...
	void setTag() {
		...
		tag.setLayout(null);
		tag.setBounds(0, 0, FrameSize.width / 6,
...
//		portraitLabel.setIcon(scaleImage(new ImageIcon(),115,92));
		...
		score_2.setBounds(FrameSize.width/3+250, FrameSize.height / 7+100, 80, 80);
		score_3.setBounds(FrameSize.width/3+250, 2*FrameSize.height / 7+100, 80, 80);
		score_4.setBounds(FrameSize.width/3+250, 3*FrameSize.height / 7+100, 80, 80);
		score_5.setBounds(FrameSize.width/3+250, 4*FrameSize.height / 7+100, 80, 80);
