...
//		show.add(choose);
	...
	void showMessage_player() {
		...
		}catch(Exception e){portrait_1.setIcon(scaleImage(new ImageIcon(Toolkit.getDefaultToolkit().getImage("image/noimage.jpg")),115,92));}
		...
		}catch (Exception e){portrait_2.setIcon(scaleImage(new ImageIcon(Toolkit.getDefaultToolkit().getImage("image/noimage.jpg")),69,55));}
		...
		}catch (Exception e){portrait_3.setIcon(scaleImage(new ImageIcon(Toolkit.getDefaultToolkit().getImage("image/noimage.jpg")),69,55));}
		...
		}catch (Exception e){portrait_4.setIcon(scaleImage(new ImageIcon(Toolkit.getDefaultToolkit().getImage("image/noimage.jpg")),69,55));}
		...
		}catch (Exception e){portrait_5.setIcon(scaleImage(new ImageIcon(Toolkit.getDefaultToolkit().getImage("image/noimage.jpg")),69,55));}
